package com.electronicGuideCQ.util;
...
//			String writeTempPath = "D:\\resource";
			...
			String avaPath ="/ElectronicGuide/upload/"+folder+"/"+fileName;
//			String writeTempPath = request.getSession().getServletContext().getRealPath("/");
			//String realPath="D:\\resource\\ElectronicGuide\\";
			String realPath="D:\\resource\\ElectronicGuide\\"+folder+"\\";
